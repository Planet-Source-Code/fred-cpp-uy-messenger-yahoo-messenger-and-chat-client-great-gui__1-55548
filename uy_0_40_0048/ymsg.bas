...
Public Sub MPRecibed(data As String)
    'YMSG*****~****∑pC 5¿Ämodule_ocx¿Ä4¿Äfreddemilena¿Ä97¿Ä1¿Ä14¿Ä<FADE #011e83,#022ec4,#011e83>[1m<font face="Verdana">Hola</FADE>¿Ä63¿Ä;0¿Ä64¿Ä0¿Ä
    ...
    ni = InStr(24, data, "¿Ä", vbTextCompare)
    sMsgTo = Mid(data, 24, ni - 24)  ' InStr(ni + 1, data, "¿Ä", vbTextCompare) - ni - 2)
    'GetFrom
    ni = InStr(ni + 2, data, "¿Ä", vbTextCompare)
    sMsgFrom = Mid(data, ni + 2, InStr(ni + 1, data, "¿Ä", vbTextCompare) - ni - 2)
    'GetMessage
    ni = InStr(ni + 2, data, "14¿Ä", vbTextCompare)
    'Debug.Print data
    sMessage = Mid(data, ni + 4, InStr(ni + 4, data, "¿Ä", vbTextCompare) - ni - 4)
    If bAceptIMs = 1 Then
